...
TurtleRPDropdownOptions["experience"]['a'] = localize("profile.rp.experience.options.none")
TurtleRPDropdownOptions["experience"]['b'] = localize("profile.rp.experience.options.little")
TurtleRPDropdownOptions["experience"]['c'] = localize("profile.rp.experience.options.advanced")
TurtleRPDropdownOptions["experience"]['d'] = localize("generic.doNotShow")
TurtleRPDropdownOptions["walkups"] = {}
TurtleRPDropdownOptions["walkups"]['a'] = localize("profile.rp.walkUps.options.anyone")--"Welcomes Walk-Ups"
TurtleRPDropdownOptions["walkups"]['b'] = localize("profile.rp.walkUps.options.none")--"No Walk-Ups"
TurtleRPDropdownOptions["walkups"]['c'] = localize("profile.rp.walkUps.options.guild")--"Guild Only"
TurtleRPDropdownOptions["walkups"]['d'] = localize("generic.doNotShow")
TurtleRPDropdownOptions["injury"] = {}
TurtleRPDropdownOptions["injury"]['a'] = localize("profile.rp.injury.options.acceptable")--"Acceptable"
TurtleRPDropdownOptions["injury"]['b'] = localize("profile.rp.injury.options.askFirst")--"Ask First"
TurtleRPDropdownOptions["injury"]['c'] = localize("profile.rp.injury.options.no")--"No"
TurtleRPDropdownOptions["injury"]['d'] = localize("generic.doNotShow")
TurtleRPDropdownOptions["romance"] = {}
TurtleRPDropdownOptions["romance"]['a'] = localize("profile.rp.romance.options.looking")--"Looking"
TurtleRPDropdownOptions["romance"]['b'] = localize("profile.rp.romance.options.relationship")--"In A Relationship"
TurtleRPDropdownOptions["romance"]['c'] = localize("profile.rp.romance.options.open")--"Open Relationship"
TurtleRPDropdownOptions["romance"]['d'] = localize("profile.rp.romance.options.committed")--"Committed"
TurtleRPDropdownOptions["romance"]['e'] = localize("profile.rp.romance.options.askFirst")--"Ask First"
TurtleRPDropdownOptions["romance"]['f'] = localize("profile.rp.romance.options.no")--"No"
TurtleRPDropdownOptions["romance"]['g'] = localize("generic.doNotShow")
TurtleRPDropdownOptions["death"] = {}
TurtleRPDropdownOptions["death"]['a'] = localize("profile.rp.death.options.acceptable")--"Acceptable"
TurtleRPDropdownOptions["death"]['b'] = localize("profile.rp.death.options.askFirst")--"Ask First"
TurtleRPDropdownOptions["death"]['c'] = localize("profile.rp.death.options.no")--"No"
TurtleRPDropdownOptions["death"]['d'] = localize("generic.doNotShow")
